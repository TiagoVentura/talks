---
title: " <span style = 'font-size: 80%;'> Does Exposure to Online Misinformation Affect Beliefs? Evidence from a Deactivation Experiment on WhatsApp </span>"
...
date: " <span style = 'font-size: 60%;'> <br> APSA Conference<br> 09/31/2023 </span>"
output:
...
<div class="my-footer"><span>Tiago Ventura (Georgetown University) &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp APSA Conference</span></div> 
...
.content-box-gray[Provide causal estimates for the effects of WhatsApp  on exposure, beliefs for misinformation and downstream political attitudes]


---
class: middle

`r icons::fontawesome("arrow-alt-circle-right")` **Previous Deactivation studies:** full deactivation on Facebook, and mixed-results on effects on beliefs for misinformation and polarization  .red[(Asimovic et al., 2021; Allcott et al., 2020)]
...
- Minimal effects vs power analysis
...
### Multi-Country Extension: Mexico, South Africa and India. 
