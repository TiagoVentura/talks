...
date: " <span style = 'font-size: 60%;'> <br> UW SR-SCP Workshop<br> 05/05/2023 </span>"
output:
...
<div class="my-footer"><span>Tiago Ventura (CSMaP) &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp UW SR-SCP Workshop</span></div> 
...
## Three insights from the recent literature on social media and politics. 

---
class: middle 

## People .red[aren’t] actually exposed to a lot of .red[misinformation] – but exposure is heavily concentrated. 
---
class:middle 
...
## The downstreamm effects of being exposed to misinformation on political atttitudes are .red[difficult to measure, often small in size, and context dependent]. 
...
## Most of the scholarly evidence come from a .red[advanced democracies] and from a .red[few platforms] (mostly Twitter, and to some extent Facebook)

---
class:middle

### For years, WhatsApp has been the .red[main social media applicattion] in many Global South democracies.
...
## WhatsApp Constrained Deactivation Field Experiment during the three weeks leading up to the 2022 Presidential Election in Brazil.
