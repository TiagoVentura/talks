...
date: " <span style = 'font-size: 80%;'> <br> 14 Encontro da ABCP  </span>"
output:
...
<div class="my-footer"><span>Tiago Ventura (Georgetown University) &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  ABCP </span></div> 
...
`r icons::fontawesome("arrow-alt-circle-right")` .red[**Downstream effects on attitudes: less than you think**]: 
...
`r icons::fontawesome("arrow-alt-circle-right")` **.red[Majority of scholarly work comes from W.E.I.R.D countries]**:
