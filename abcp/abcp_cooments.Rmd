...
- non-probability sampling: part os membros de uma população têm a chance de serem selecionados para a amostra

- non-ignorable nonresponse: a decisão dos parlamentares em não responder é endogena as variáveis de interesse da pesquisa. ($(R_{i1}, R_{i0} \perp Y_i)$)
