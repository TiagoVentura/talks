...
date: " <span style = 'font-size: 60%;'> <br> 80th Annual MPSA Conference <br> 04/15/2023 </span>"
output:
...
## WhatsApp Multimedia Deactivation Field Experiment during the weeks leading up to the 2022 Presidential Election in Brazil
...
`r icons::fontawesome("arrow-alt-circle-right")` **Our Solution:** Cut the primary channels through which users are exposed to misinformation and polarizing content: videos, images and audios .red[(Machado et al., 2019; Resende et al., 2019; Garimella and Tyson, 2018; Garimella and Eckles, 2020; Batista Pereira et al., 2023).]
...
- Facebook Ads targeting adults Brazil

- Started on September 8th

- Number of respondents: 1,947

- Participants willing to join the deactivation: 1,8861
...
- **Started the experiment on September 15**

- **Treatment**:
  
  - Turn off the automatic download of all multimedia
  - Three .red[weeks] without consuming images, videos, and audio on WhatsApp
  
- **Control**:

  - Three .red[days] without consuming images, videos, and audio on WhatsApp
...
.panel[.panel-name[Compliance Checks]
...
#### .darkblue[General Info]

- October 5th, three days after the election
...
- Larger effect might exist exactly in hard to reach populations.
