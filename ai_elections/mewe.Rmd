...
date: " <span style = 'font-size: 80%;'> <br> Mewe & Georgetown Collaboration <br> <br> 03/14/2024 </span>"
output:
...
---
class: middle
### The Effects of Digita Media on Democracy
...
`r icons::fontawesome("arrow-alt-circle-right")` Randomized interventions allow us to isolate causal effects. The most useful interventions come from collaborations between industry and independent researchers
...
- Downrank content from like-minded sources
- Remove re-shares
...
`r icons::fontawesome("arrow-alt-circle-right")` RCT + Data. Main points of the collaboration:
...
- Removing reshared content on Facebook substantially decreased the amount of political news and content from untrustworthy sources people saw in their feeds 
   - But decreased news knowledge and do not affect political polarization ([Guess et. al. 2023a](https://www.science.org/doi/full/10.1126/science.add8424))

- Using chronological news feed decreased time and engagement in the platform, increased content from moderate friends and sources with ideologically mixed audiences ([Guess et. al. 2023b](https://www.science.org/doi/full/10.1126/science.abp9364))
  - But also shows null effects on attitudinal outcomes. 
  
  
- Most of the content people see on Facebook comes from like-minded ~ Echo Chambers do exist. 
  - Breaking the echo-chamber had no measurable effects on attitudinal measures such as affective polarization, ideological extremity, candidate evaluations and belief in false claims ([Nyhan et. al. 2023](https://www.nature.com/articles/s41586-023-06297-w))
...
- Are these effects specific to the Facebook population?

- Variations across platforms?

- Most of these interventions lasted for a month. Do attitudes need more time to be shaped?

- What are the constraints of running these studies during elections?
