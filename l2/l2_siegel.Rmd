...
--
**Heightened levels of olarization have become a striking feature of contemporary politics, affecting, for example: **. 
...
- Rather than isolating users in homogenous online echo chambers, social media actually exposes users content that they would hardly not be exposed outside of social media. 
...
### Social Media studies has focused so much on levels of online partisan sorting, but in the process, we lost sight of our local bubbles and how they interact with how users behave online. 
...
We link a novel dataset of the offline networks and online networks of ~1m Twitter users. 
