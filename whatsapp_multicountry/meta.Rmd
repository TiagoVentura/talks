...
date: " <span style = 'font-size: 80%;'> <br> META, August 5 2025 </span> <br> <br> <span style = 'font-size: 70%;' > We gratefully acknowledge funding from McCourt School's Tech and Policy Program and Project Liberty’s Institute for this project. "
output:
...
<div class="my-footer"><span>Tiago Ventura (Georgetown University) &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp at META </span></div> 
...
**From Liberation to Turmoil:** After early years of optimism, the past ten years of the public and academic debate about social media usage have increasingly focused on its negative consequences on society and politics. Social Media is said to:
--
...
---
class:middle
### Challenges on the current stage of the social media and politics literature

--

#### Overemphasis on feed-based platforms
...
####  Most research is concentrated in a handful of high-income countries:
...
- **Problem I:** In a context of widely adoption of certain social media applications, RCTs "treating" users with social media have several theoretical  constraints. 
   ...
   - **Solution:** Instead of "activating", researchers have used deactivation designs .midgrey[(Asimovic et al., 2022, Allcott et al., 2020, Arceneaux and Ladd 2023)]: 
      - Measure the short term causal effects of social media usage 
      - Around specific event, mainly elections!
--

- **Problem II **: Fully deactivating WhatsApp users brings additional empirical challenges:
...
- **Problem III **: WhatsApp is end-to-end encrypted, with a lot of sensitive data. 
...
## My attempts to deal with these problems

 `r icons::fontawesome("arrow-alt-circle-right")` Misinformation Exposure Beyond Traditional Feeds: Evidence from a WhatsApp Deactivation Experiment in Brazil -- With Rajeshwari Majumdar, Jonathan Nagler, and Joshua A. Tucker (*Forthcoming at The Journal of Politics*)

#### `r icons::fontawesome("arrow-alt-circle-right")` Reducing Social Media Usage During Elections: Evidence from a Multi-Country WhatsApp Deactivation Experiment -- With Rajeshwari Majumdar, Shelley Liu, Carolina Torreblanca, and Joshua A. Tucker *(Presentation Today!)*
...
### WhatsApp Partial Deactivation Experiment

--

#### `r icons::fontawesome("arrow-alt-circle-right")` **Design:** Partial Deactivation -> Friction + Incentive to reduce usage:

   - **Time Treatment:** Add time limit for WhatsApp usage per day + Limit Usage to 5min per day;
   - **Media Treatment**: Disable their automatic download of media on WhatsApp, and do not purposefully click and watch any media on WhatsApp(.midgrey[Ventura et al., 2025])

--

#### `r icons::fontawesome("arrow-alt-circle-right")` **Duration:** 
...
`r icons::fontawesome("arrow-alt-circle-right")` **Multicountry Design:** selected some of the largest Global South countries having democratic elections in 2024.
...
- Changing Facebook feed to chronological instead of algorithmic .midgrey[(Guess et al., 2023a)]


- Removing re-shares from people's Facebook News Feed .midgrey[(Guess et al., 2023b)]
...
## Social Media App Substitution

```{r out.width="80%"}
knitr::include_graphics("output/left_plot_app_subs.png")
```
...
```{r out.width="80%"}
knitr::include_graphics("output/het_wpp_usage.png")
```
...
```{r out.width="80%"}
knitr::include_graphics("output/itt_cov_substitution_right.png")
```
