...
- Scholarly evidence that social media facilitates the spread of misinformation and polarizing content .midgrey[(Aruguete, Calvo and Ventura, 2021; Del Vicario et al., 2016; Nyhan et al., 2023; Eady et al., 2023)].

--

- Often see claims that exposure to misinformation affect democratic outcomes, like elections .midgrey[(Bovet and Makse, 2019; Recuero, Soares and Gruzd, 2020; Mello, 2020)]), attitudes and behaviors, as vaccine hesitancy  .midgrey[(Loomba et al., 2021, Van der Linden et al., 2017)] and offline violence .midgrey[(Saha et al., 2021; Banaji et al., 2019)]
...
- **.red[But]**:
  ...
  - Exposure to misinformation is concentrated among small set of (heavily engaged) users .midgrey[(Grinberg et al., 2019)]
